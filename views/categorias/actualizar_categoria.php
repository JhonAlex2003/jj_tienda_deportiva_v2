...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($controller->actualizar($id, $nombre, $descripcion)) {
        header("Location: listar_categorias.php");
        exit;
    } else {
...
<div class="d-flex align-items-center justify-content-between mb-4">
    <div>
        <h5 class="fw-bold mb-1" style="color:#1a2942;">Editar Categoría</h5>
        <p class="text-muted mb-0" style="font-size:0.825rem;">
            Modificando: <strong><?= htmlspecialchars($categoria['nombre']) ?></strong>
        </p>
    </div>
    ...
    <div class="col-lg-5">
        <div class="card">
            <div class="card-header">
                <i class="bi bi-pencil me-2 text-warning"></i>Información de la categoría
            </div>
